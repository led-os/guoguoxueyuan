...
public class WheelView extends View {
   ...
   /* private int[] SHADOWS_COLORS = new int[]{0xefE9E9E9,
    ...
    private int[] SHADOWS_COLORS = new int[]{80000000,
            00000000, 80000000};
...
//    private int wheelBackground = R.drawable.wheel_bg;
        private int wheelBackground = R.color.touming;
    private int wheelForeground = R.color.touming;
//    private int wheelForeground = R.drawable.wheel_val;
//    private int wheelBackground = R.drawable.edit_back;
//    private int wheelForeground = R.drawable.edit_back;
