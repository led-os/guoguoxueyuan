package com.test720.grasshoppercollege.module.yuWen.yuYanPinYinShiZi.shiZi;
...
public class ShiZiShouYeActivity extends BaseShouYeActivity {
    ...
    public void adapterItemClick(String id, String state,String title) {
        Intent in = new Intent(mcontext, ShiZiVideo2Activity.class);
