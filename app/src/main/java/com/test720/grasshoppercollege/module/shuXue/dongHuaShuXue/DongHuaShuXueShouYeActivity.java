...
public class DongHuaShuXueShouYeActivity extends BaseShuXueShouYeActivity {
    ...
    public void adapterItemClick(String id, String state, String title) {
        Intent in = new Intent(mcontext, DongHuaVideoActivity.class);
