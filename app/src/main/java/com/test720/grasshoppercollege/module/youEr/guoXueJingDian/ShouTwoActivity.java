package com.test720.grasshoppercollege.module.youEr.guoXueJingDian;
...
public class ShouTwoActivity extends BaseShouQuanXianActivity {
    ...
    public FormBody.Builder formBuilder() {
        ...
        if (getIntent().getStringExtra("parent_id") != null) {
            builder.add("parent_id", getIntent().getStringExtra("parent_id"));
        } else {
