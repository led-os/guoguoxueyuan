...
public class GuoGuoDouJiLvActivity extends BaseTwoRecyclerViewActivity<DouDouJiLVData.DataBean> {
    ...
    public ReflshInit reflshInit() {
        return new ReflshInit() {
            ...
            @Override
            public String reUrl() {
                return HttpUntil.GetIntent().getIP() + "small.php/User/pointsRecord";//果果豆记录
            }
