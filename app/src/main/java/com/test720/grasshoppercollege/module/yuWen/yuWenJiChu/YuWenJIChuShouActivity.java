...
public class YuWenJIChuShouActivity extends PublickMyBooksActivity {
    ...
    @Override
    public void add() {
        jumpToActivity(YuWenAddActivity.class, false);
    }
    ...
    protected void initData() {
        ...
        adapter = new MyBookAdapter<DianDuMyBookData.DataBean.ListBean>(list, this) {
            ...
            public void bookClick(int position) {
                Intent in = new Intent(mcontext, YuWenUnitActivity.class);
