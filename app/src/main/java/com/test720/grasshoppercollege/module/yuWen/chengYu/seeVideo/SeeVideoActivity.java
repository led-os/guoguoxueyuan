...
import com.test720.grasshoppercollege.HttpBean.SeeVideoData;
...
public class SeeVideoActivity extends Mp4Activity {
    String url;

    @Override
    public String url() {
        return HttpUntil.GetIntent().ChineseIdiomcontent();
    }

    @Override
    public void shuaXin(String str) {
        if (codeIsOne(str, false)) {
            SeeVideoData data = new Gson().fromJson(str, SeeVideoData.class);
            /*点赞，分享，评论*/
    ...
    public void pingLunXiangQing(PingLunData item) {
        Intent in = new Intent(mcontext, SeeVideoPinLunXiangQingActivity.class);
    ...
    @Override
    public void PingJia() {
        Intent in = new Intent(mcontext, SeeVideoPingLunActivity.class);
    ...
    public String vodeoId() {
        return getIntent().getStringExtra("look_id");
    }
}
