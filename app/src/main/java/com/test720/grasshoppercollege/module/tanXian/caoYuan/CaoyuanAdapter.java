 ...
 */
public class CaoyuanAdapter extends BaseTanXianAdapter {


    public CaoyuanAdapter(List<List<TanXianGuanKaData.DataBean>> list, AppCompatActivity context) {
        super(list, context);
    }

    @Override
    public int onelayout() {
        return R.layout.tan_xian_cao_yuan_one;
    }

    @Override
    public int twolayout() {
        return R.layout.tan_xian_cao_yuan_two;
    }

    @Override
    public int threelayout() {
        return R.layout.tan_xian_cao_yuan_three;
    }

    @Override
    public int fourlayout() {
        return R.layout.tan_xian_cao_yuan_four;
    }
