...
/**
 * Created by 水东流 on 2018/7/25.
 */

public class YingYongDanXuanFragment extends BaseTiMuOkFragment {
    ...
    public void onStart() {
        ...
        if (listBean.getSelect_a() != null) {
            ...
            a.setText("A：" + listBean.getSelect_a());
        } else {
            a.setVisibility(View.GONE);
        }
        if (listBean.getSelect_b() != null) {
            b.setVisibility(View.VISIBLE);
            b.setText("B：" + listBean.getSelect_b());
        } else {
            b.setVisibility(View.GONE);
        }
        if (listBean.getSelect_c() != null) {
            c.setVisibility(View.VISIBLE);
            c.setText("C：" + listBean.getSelect_c());
        } else {
            c.setVisibility(View.GONE);
        }
        if (listBean.getSelect_d() != null) {
            d.setVisibility(View.VISIBLE);
            d.setText("D：" + listBean.getSelect_d());
        } else {
