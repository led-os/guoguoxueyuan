package com.test720.grasshoppercollege.module.zhuYiLiXuLian.fragment;
...
import com.test720.grasshoppercollege.module.zhuYiLiXuLian.VideoActivity;
    ...
    public void onStart() {
        ...
        adapter.setOnItemClickListener(new MyBaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                strings[2] = HttpUntil.GetIntent().getShare() + "53";
