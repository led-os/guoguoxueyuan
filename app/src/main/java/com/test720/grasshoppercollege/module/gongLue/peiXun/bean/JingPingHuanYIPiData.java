 ...
 */
public class JingPingHuanYIPiData {
    /**
     * code : 1
     * msg : 成功
    ...
    private int code;
    private String msg;
    private List<PeiXunShouData.DataBean.BestSchoolBean> data;
    ...
    public List<PeiXunShouData.DataBean.BestSchoolBean> getData() {
        return data;
    }
    public void setData(List<PeiXunShouData.DataBean.BestSchoolBean> data) {
        this.data = data;
    }
}
