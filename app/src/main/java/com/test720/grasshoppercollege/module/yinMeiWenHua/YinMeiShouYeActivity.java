...
import com.test720.grasshoppercollege.HttpBean.YinMeiWenHuaShouYeData;
...
public class YinMeiShouYeActivity extends BaseShouQuanXianActivity {
    ...
    List<YinMeiWenHuaShouYeData.DataBean> list = new ArrayList();
    ...
    protected void initData() {
        ...
        adapter = new MyBaseRecyclerAdapter<YinMeiWenHuaShouYeData.DataBean>(list, this, R.layout.shu_xue_shou_item) {
            @Override
            public void convert(BaseRecyclerHolder holder, YinMeiWenHuaShouYeData.DataBean item, int postion) {
        ...
        adapter.setOnItemClickListener(new MyBaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                shareStr[2] = HttpUntil.GetIntent().getShare() + 17;
                re_id = list.get(position).getEncc_id();
                ...
                if (canSee) {
                    Intent in = new Intent(mcontext, YinMeiWenHuaVideoActivity.class);
                    in.putExtra("title", list.get(position).getName());
                    in.putExtra("encc_id", list.get(position).getEncc_id());
    ...
    @Override
    public String url() {
        return HttpUntil.GetIntent().EnCultureindex();
    }

    @Override
    public void shuaXin(String str) {
        if (codeIsOne(str, false)) {
            YinMeiWenHuaShouYeData data = new Gson().fromJson(str, YinMeiWenHuaShouYeData.class);
            list.clear();
