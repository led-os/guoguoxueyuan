...
public class DuiHuanJiLvActivity extends BaseTwoRecyclerViewActivity<DouDouJiLVData.DataBean> {
    ...
    public ReflshInit reflshInit() {
        return new ReflshInit() {
            ...
            @Override
            public String reUrl() {
                return HttpUntil.GetIntent().getIP() + "small.php/User/exchangeRecord";//兑换记录
            }
