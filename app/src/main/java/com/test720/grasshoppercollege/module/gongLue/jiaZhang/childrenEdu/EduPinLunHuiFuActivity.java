...
public class EduPinLunHuiFuActivity extends BasePingJiaActivity {
    ...
    public void pinLun(List<String> pathList) {
        ...
        builder.put("jiaozi_id", getIntent().getStringExtra("jiaozi_id"));
        ...
        postResponse(HttpUntil.GetIntent().StrategyparentJiaoZiComment(), builder, 5, true);
    }
