package com.test720.grasshoppercollege.module.gongLue.student.myCollection;
...
public class MyCollectionActivity extends BaseTwoRecyclerViewActivity<MyCollectionData.DataBean> {
    ...
    protected void initData() {
        setAdapter(new MyBaseRecyclerAdapter<MyCollectionData.DataBean>(getList(), mcontext, R.layout.teacher_gong_lu_item) {
            @Override
            public void convert(BaseRecyclerHolder holder, MyCollectionData.DataBean item, int postion) {
                ...
                holder.setText(R.id.fans_num, item.getFans());
