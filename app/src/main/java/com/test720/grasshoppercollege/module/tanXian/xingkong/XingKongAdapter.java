 ...
 */
public class XingKongAdapter extends BaseTanXianAdapter{

    public XingKongAdapter(List<List<TanXianGuanKaData.DataBean>> list, AppCompatActivity context) {
        super(list, context);
    }

    @Override
    public int onelayout() {
        return R.layout.tan_xian_xing_kong_one;
    }

    @Override
    public int twolayout() {
        return R.layout.tan_xian_xing_kong_two;
    }

    @Override
    public int threelayout() {
        return R.layout.tan_xian_xing_kong_three;
    }

    @Override
    public int fourlayout() {
        return R.layout.tan_xian_xing_kong_four;
    }
