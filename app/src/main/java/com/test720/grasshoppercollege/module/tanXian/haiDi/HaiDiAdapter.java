 ...
 */
public class HaiDiAdapter extends BaseTanXianAdapter{



    public HaiDiAdapter(List<List<TanXianGuanKaData.DataBean>> list, AppCompatActivity context) {
        super(list, context);
    }

    @Override
    public int onelayout() {
        return R.layout.tan_xian_hai_di_one;
    }

    @Override
    public int twolayout() {
        return R.layout.tan_xian_hai_di_two;
    }

    @Override
    public int threelayout() {
        return R.layout.tan_xian_hai_di_three;
    }

    @Override
    public int fourlayout() {
        return R.layout.tan_xian_hai_di_four;
    }
