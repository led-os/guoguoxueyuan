...
public class ClassXCXQActivity extends BaseTwoRecyclerViewActivity<XiangCeXiangQingData.DataBean.ListBean> {
    ...
    public ReflshInit reflshInit() {
        return new ReflshInit() {
            ...
            @Override
            public String reUrl() {
                return HttpUntil.GetIntent().StrategyChildphotoList();
            }
