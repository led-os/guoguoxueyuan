...
public class JiChuTiMuActivity extends BaseTiMuActivity {
    ...
    protected void initData() {
        ...
        setType(getIntent().getIntExtra("type", 19));
        FormBody.Builder builder = new FormBody.Builder();
        builder.add("book_id", bookId);
        builder.add("page", page);
        builder.add("unit", unit);
        Post(HttpUntil.GetIntent().MathBasicPracticebookContent(), builder, 1);
