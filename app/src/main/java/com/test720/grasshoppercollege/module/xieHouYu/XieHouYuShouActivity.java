...
public class XieHouYuShouActivity extends BaseToolActivity {
    ...
    protected int setlayoutResID() {
        return R.layout.activity_xie_hou_yu_shou;
    }

    @Override
    protected void initData() {
        fragmentList = new ArrayList<>();
        fragmentList.add(new LianXiFragment());
        fragmentList.add(new TongGuanFragment());
        fragmentList.add(new BaoDianShouFragment());
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.lin4:
                ...
                MyApplication.getmInstance().setLoginDialogIsShow(false);
                if (!MyApplication.getmInstance().getUid().equals("")) {
                    jumpToActivity(XieHouJieLeiActivity.class, false);
                }
                break;
            case R.id.lin5:
                playAnimBack();
