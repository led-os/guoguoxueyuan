...
public class JiChuShouActivity extends PublickMyBooksActivity {
    public List<DianDuMyBookData.DataBean.ListBean> list = new ArrayList();
    private MyBookAdapter adapter;

    @Override
    public String url() {
        return HttpUntil.GetIntent().MathBasicPracticemyBookList();
    }
    ...
    @Override
    public void add() {
        jumpToActivity(JIChuAddActivity.class, false);
    }
    ...
    protected void initData() {
        ...
        adapter = new MyBookAdapter<DianDuMyBookData.DataBean.ListBean>(list, this) {
            ...
            public void onBindViewHolder(MyBookAdapter.ViewHolder holder, int position) {
                ...
                Glide.with(JiChuShouActivity.this).load(list.get(pos).getPic()).into(holder.one);
                ...
                if (list.size() > (pos + 1)) {
                    Glide.with(JiChuShouActivity.this).load(list.get(pos + 1).getPic()).into(holder.two);
            ...
            public void bookClick(int position) {
                Intent in = new Intent(JiChuShouActivity.this, JiChuUnitlActivity.class);
    ...
    public void delBook(String id) {
        ...
        Post(HttpUntil.GetIntent().MathBasicPracticedelBook(), formBuilder, 5);
    }
}
