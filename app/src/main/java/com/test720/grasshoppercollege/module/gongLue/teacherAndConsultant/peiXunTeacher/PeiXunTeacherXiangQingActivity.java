package com.test720.grasshoppercollege.module.gongLue.teacherAndConsultant.peiXunTeacher;
...
import com.test720.grasshoppercollege.module.gongLue.student.onLine.YuYueDialog;
...
public class PeiXunTeacherXiangQingActivity extends BaseToolActivity {
    ...
    protected int setlayoutResID() {
        return R.layout.activity_pei_xun_teacher_xq;
    }
...
//        title.setText(data.getData().getInfo().getNickname());
        ...
        thanksNum.setText(data.getData().getInfo().getThanks_count());
        ...
        fuWuFragment.setArguments(bundle2);
    ...
    @OnClick({R.id.seeJieShao, R.id.head, R.id.back, R.id.guan_zhu, R.id.yuYue, R.id.shiTing})
    ...
    private void teacherYuYue(final String Id, final String status) {
        ...
        yuYueDialog.setClick(new YuYueDialog.Click() {
            ...
            public void nameAndPhone(String name, String phone, String nianji) {
                HttpParams httpParams = new HttpParams();
                httpParams.put("line_id", Id);
                httpParams.put("name", name);
                httpParams.put("status", status);
                httpParams.put("phone", phone);
                httpParams.put("grade", nianji);
                httpParams.put("uid", MyApplication.getmInstance().getUid());
                postResponse(HttpUntil.GetIntent().StrategylineYuYue(), httpParams, 6, true);
            }
        });
