...
public class FanYiShouYeActivity extends PublickMyBooksActivity {
    ...
    @Override
    public void add() {
        jumpToActivity(FanYiAddBookActivity.class, false);
    }
    ...
    protected void initData() {
        adapter = new MyBookAdapter<JiangJieShouYeData.DataBean.ListBean>(list, this) {
            ...
            public void bookClick(int position) {
                Intent in = new Intent(mcontext, FanYiGuanKaActivity.class);
