...
public class WoAiTingXiePinJiaHuiFuActivity extends BasePingJiaActivity {
    ...
    public void pinLun(List<String> pathList) {
        ...
        builder.put("love_id", getIntent().getStringExtra("love_id"));
        ...
        postResponse(HttpUntil.GetIntent().EnLoveDictationaddComment(), builder, 5, true);
    }
}
