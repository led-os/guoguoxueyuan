...
public class OnLinePinLunListActivity extends BaseRecyclerViewActivity {
    ...
    @Override
    public String url() {
        return HttpUntil.GetIntent().getLineInfoCommentineInfo();
    }
    ...
    public FormBody.Builder formBuilder() {
        ...
        httpParams.add("line_id", line_id);
    ...
    protected void initData() {
        ...
        pinLunUntil = new PinLunUntil(list, mcontext, new PinLunUntil.PinLunInterface() {
            ...
            public void Zan(String commentId, int pos) {
                ...
                postResponse(HttpUntil.GetIntent().StrategylineThumbUp(), httpParams, 5, false);
            }
            ...
            public void Reply(String commentId, String name) {
                ...
                in.putExtra("line_id", line_id);
                jumpToActivity(in, false);
            }

            @Override
            public void ItemClick(PingLunData item) {
                Intent in = new Intent(mcontext, OnLinePinLunXiangQingActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.down:
                MyApplication.getmInstance().setLoginDialogIsShow(false);
                if (MyApplication.getmInstance().getUid().equals("")) return;
                Intent intent = new Intent(mcontext, OnLinePingJiaActivity.class);
