package com.test720.grasshoppercollege.module.tanXian.TypeOfQuestion.shuXueAoShuLianXi;
...
public class DanXuanFragment extends BaseTanXianTiMuFragment {
    ...
    public void startShow() {
        if (getBean().getSelect_a() != null) {
            ...
            a.setText(getBean().getSelect_a());
        } else {
            a.setVisibility(View.GONE);
        }
        if (getBean().getSelect_b() != null) {
            b.setVisibility(View.VISIBLE);
            b.setText(getBean().getSelect_b());
        } else {
        ...
        if (getBean().getSelect_c() != null) {
            ...
            c.setText(getBean().getSelect_c());
        } else {
            c.setVisibility(View.GONE);
        }
        if (getBean().getSelect_d() != null) {
            d.setVisibility(View.VISIBLE);
            d.setText(getBean().getSelect_d());
        } else {
    ...
    private void check(String s) {
        ...
        dialog.setRightAnswer(getBean().getAnswer().get(0));
